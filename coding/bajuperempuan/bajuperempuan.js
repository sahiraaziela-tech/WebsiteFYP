...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Audio penerangan umum (disimpan dalam variabel jika perlu guna nanti)
  ...
  const audioMap = {
    Mandapun: new Audio("/WebsiteFYP/assets/sound/MandapunP.mp3"),
    Sarempak: new Audio("/WebsiteFYP/assets/sound/SarempakP.mp3"),
    Ingkot_pangkat: new Audio("/WebsiteFYP/assets/sound/Ingkot pangkatP.mp3"),
    Salempang: new Audio("/WebsiteFYP/assets/sound/SalempangP.mp3"),
  };
  ...
  // [DIHAPUS] Butang Audio HTML narrativeBtn telah dibuang.
  ...
  // A. Butang Jawapan (A. Sarempak = Betul)
  ...
  function drawQuizUI(feedback = null) {
      ...
      quizCtx.textAlign = "center"; quizCtx.fillText("MANAKAH AKSESORI KEPALA?", 256, 60);

      const options = ["A. Sarempak", "B. Mandapun", "C. Salempang", "D. Ingkot Pangkat"];
      let startY = 110; 
      ...
      if (feedback) {
         ...
         quizCtx.textAlign = "center"; quizCtx.fillText(feedback.correct ? "BETUL! A. SAREMPAK 🎉" : "SALAH. CUBA LAGI!", 256, 495);
      }
  ...
  const gltf = await gltfLoader.loadAsync("/WebsiteFYP/assets/models/bajuperempuan.glb");
